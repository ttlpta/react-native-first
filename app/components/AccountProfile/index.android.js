...
import {
  ...
  ICON_CAMERA_BLACK, ICON_ICE, ICON_LOGOUT, ICON_RIGHT, ICON_REAL_DOCTOR_DEFAULT, CHECKED, UNCHECKED
...
class AccountProfile extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      sex: true,
      // sex: (props.profilePatient.sex === 'M' ? true : false) 
    };
  }
  ...
  componentWillMount() {
    ...
    // this.setState({ data: profilePatient });
