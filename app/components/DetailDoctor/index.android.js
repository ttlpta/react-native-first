...
import {
  ...
  Text, TextInput, Image, Switch, Modal, Input, Picker, Platform
} from 'react-native';
...
class DetailDoctor extends React.PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.isBookingDoctor && !nextProps.isBookingDoctor) {
      ...
      if (nextProps.isBookingSuccess) {
        ...
        this.dropdown.alertWithType('error', 'Đặt lịch hẹn thất bại', nextProps.loginErrorMsg);
      }
    }
  }
          ...
          <TouchableOpacity activeOpacity={1} onPress={() => false} style={temp.containerModal}>
            ...
            <View style={temp.containerModalCalendar}>
              ...
              <View style={temp.containerModalCalendarItem}>
                ...
                {/* <Text style={temp.txtBold}>Thứ 5, 16/07/2017</Text> */}
                <DatePicker
  ...
  renderCheckoutSuccessModal() {
    return (
      <Modal
        animationType={"fade"}
        transparent={true}
        /* onRequestClose={this.setState({checkoutSuccessModalVisible : false})} */
  ...
  renderPriceDetail() {
    // const price = this.props.info.balance + " VNĐ\n" + I18n.t('DetailDoctor.turnExamination' );
  ...
  renderViewOnEcoWebsiteButton() {
    return (
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        ...
        {/*<View style={styles.viewOnEcoWebsiteContainer}>
          <TouchableOpacity onPress={this.openRankingPopup}>
            <View style={styles.viewOnEcoWebsiteInnerContainer}>
              <Text style={styles.viewOnEcoWebsiteText}>&#x2606; {I18n.t('DetailDoctor.rank' )} &#10095;</Text>
            </View>
          </TouchableOpacity>
        </View>*/}
      </View>
